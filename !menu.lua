...
function update()
    ...
    downloadUrlToFile("https://www.dropbox.com/scl/fi/lmpzympj3vqu3mljsi44a/update.json?dl=1", updatePath, function(id, status, p1, p2)
            ...
            if file and doesFileExist(updatePath) then
                ...
                if info.version ~= thisScript().version then
                    lua_thread.create(function()
                        ...
                        downloadUrlToFile("https://www.dropbox.com/scl/fi/fqn5vjfwpx96td5c2ov93/menu.lua?dl=1", thisScript().path, function(id, status, p1, p2)
                            if status == dlstatus.STATUS_ENDDOWNLOADDATA then
...
function main()
    ...
    --update()
    --autoupdate('https://www.dropbox.com/scl/fi/lmpzympj3vqu3mljsi44a/update.json?dl=0', '['..string.upper(thisScript().name)..']: ', 'https://github.com/Vis-Stu/lua-samp')
    while true do
